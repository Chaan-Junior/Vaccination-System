...
<div class="vaccines">
            ...
            <div class="Vax">
                ...
                <div class="Vax-button">
                    <a href="../views/appointment.php"><button id="btn1">Book</button></a>
                </div>
            </div>
            <div class="Vax">
                <div class="Vtitle">
                ...
                <div class="Vax-button">
                    <a href="../views/appointment.php"><button id="btn2">Book</button></a>
                </div>
            </div>
            <div class="Vax">
                <div class="Vtitle">
                ...
                <div class="Vax-button">
                    <a href="../views/appointment.php"><button id="btn3">Book</button></a>
                </div>
            </div>
            <div class="Vax">
                <div class="Vtitle">
                ...
                <div class="Vax-button">
                    <a href="../views/appointment.php"><button id="btn5">Book</button></a>
                </div>
            </div>
            <div class="Vax">
                <div class="Vtitle">
                ...
                <div class="Vax-button">
                    <a href="../views/appointment.php"><button id="btn6">Book</button></a>
                </div>
            </div>     
            <div class="Vax">
                <div class="Vtitle">
                ...
                <div class="Vax-button">
                    <a href="../views/appointment.php"><button id="btn7">Book</button></a>
                </div>
            </div>
        </div> 
        <div class="Vax">
